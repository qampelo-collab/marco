...
const DICT = {
  ...
  'Mo Tennis · Di Push · Mi Legs+Schwachstelle · Do Pull · Fr Laufen · Sa Upper #2 · So Ruhe':
    'Mon tennis · Tue push · Wed legs+weak point · Thu pull · Fri running · Sat upper #2 · Sun rest',
...
const SUBST = [
  ...
  ['Sa – Upper #2 (~40 Min)', 'Sat – Upper #2 (~40 min)'],
